...
public class OpenID4VPResponseService {
    ...
    protected Map<String, Object> retrieveClaimsFromSDJwtCredential(String vpToken) throws Exception{
        ...
        if (!verificationResult.getVerified()) {
            throw new VerificationException("invalid_request", "Invalid vp_token. Signature verified %s or/and disclosures verified is %s".formatted(verificationResult.getSignatureVerified(), verificationResult.getDisclosuresVerified()));
        }
