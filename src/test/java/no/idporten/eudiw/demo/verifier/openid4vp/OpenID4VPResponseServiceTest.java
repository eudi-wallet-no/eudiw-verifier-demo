...
class OpenID4VPResponseServiceTest {
    ...
    class SDJwt {
        ...
        @Test
        void retrieveClaimsFromSDJwtCredential_Hellas() throws Exception {
            ...
            assertTrue(e.getMessage().contains("disclosures verified is true"), e.getMessage());
        }

        // vp-token invalid?
        @DisplayName("from Italia throws expected exception due to Invalid selective disclosure")
        @Test
        void retrieveClaimsFromSDJwtCredential_Italia() throws Exception {
